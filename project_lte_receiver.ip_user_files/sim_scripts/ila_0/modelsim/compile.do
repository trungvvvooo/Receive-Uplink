...
vlog -work xpm  -incr -mfcu -sv "+incdir+../../../../project_lte_receiver.gen/sources_1/ip/ila_0/hdl/verilog" \
...
vlog -work xil_defaultlib  -incr -mfcu "+incdir+../../../../project_lte_receiver.gen/sources_1/ip/ila_0/hdl/verilog" \
